// Light / Dark THeme
const themes__toggle = document.querySelector('.themes__toggle');
const themes__toggleIsActive = document.querySelector(".themes__toggle");
const DarckThem = ()=>{
    themes__toggleIsActive.classList.toggle('themes__toggle--isActive');
}
themes__toggleIsActive.addEventListener("keydown", (event)=>{
    if(event.key ==="Enter"){
        DarckThem();
    }
})
themes__toggleIsActive.addEventListener('click' , DarckThem);
